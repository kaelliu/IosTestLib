...
// define by kael for no use boost
// main use of this file is to
// 1.split string as std::vector 's token list
/*
 std::string str = "abc|123|xyz|789";
 strtk::std_string::token_list_type token_list;
 strtk::split(" |.;?",str,std::back_inserter(token_list));
 */
// 2.split string with multi tokens
/*
 std::string data = "token1?token2,token3;token4,token5";
 strtk::std_string::token_list_type token_list;
 const std::size_t token_count = 4;
 const std::string delimiters (" ,.;?");
 strtk::split_n(delimiters,data,token_count,std::back_inserter(token_list));
 ...
 */
// 5.parse to variable use split column
/*
...
/*
 ...
 int i0,i1,i2,i3,i4;
 strtk::parse_columns(data,",;| ",strtk::column_list(0,2,4,6,8),i0,i1,i2,i3,i4);
 */
// 7.do split column with function
/*
 std::string sentence = "The quick brown fox jumps over the lazy dog";
 strtk::split(" ",sentence,
...
/*
 ...
 or just declare the type parser use marco:
 ...
 then use,but make sure your data formate is fit for right:
 type t;
 std::string s = "abcdefghijklmnop|123.456|987654321|A|1";
 strtk::parse(s,"|",t);
 */
// 9.data time formate parser
// 10.sub list parse
/*
